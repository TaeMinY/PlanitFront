      ...
      <div v-for="(value,index) in postdata" :key="index" style="width:80%">
        <div class="profile__article__box">
          <div class="profile__article__left">
            <div class="profile__article__profile">
              <div style="display:flex; align-items:center">
                <img
                  ...
                  style="object-fit:cover"
                />
                <div class="profile__article__name">{{postdata[index].name}}</div>
              </div>
              <div class="profile__article__delete" @click="deletePost(value._id)">삭제하기</div>
            </div>

            <div class="profile__article__title">{{postdata[index].data.title}}</div>
            <div class="profile__article__subtitle">{{postdata[index].data.text}}</div>
            ...
            <div class="profile__article__text">{{postdata[index].text}}</div>
          </div>
        </div>
      </div>
    </div>
